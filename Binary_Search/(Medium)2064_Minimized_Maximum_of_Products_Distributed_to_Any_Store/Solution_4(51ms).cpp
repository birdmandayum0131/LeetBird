...
class Solution
{
  public:
    int minimizedMaximum(int n, vector<int> &quantities)
    {
        ...
        int left = 1; // ? So, we don't need to calculate the start_num, cuz binary search is much more fast. (10ms
        // ? seems that sort doesn't speed up the result, conversely, it slow down the result (50ms)
